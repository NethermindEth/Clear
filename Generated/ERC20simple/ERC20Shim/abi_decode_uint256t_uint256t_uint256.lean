...
import Generated.ERC20simple.ERC20Shim.abi_decode_uint256t_uint256t_uint256_user
...
lemma abi_decode_uint256t_uint256t_uint256_abs_of_code {s₀ s₉ : State} {value0 value1 value2 headStart dataEnd} {fuel : Nat} :
  execCall fuel abi_decode_uint256t_uint256t_uint256 [value0, value1, value2] (s₀, [headStart, dataEnd]) = s₉ →
  Spec (A_abi_decode_uint256t_uint256t_uint256 value0 value1 value2 headStart dataEnd) s₀ s₉
:= λ h ↦ abi_decode_uint256t_uint256t_uint256_abs_of_concrete (abi_decode_uint256t_uint256t_uint256_concrete_of_code.2 h)
