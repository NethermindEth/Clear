...
import Generated.ERC20simple.ERC20Shim.fun_approve_515_user
...
lemma fun_approve_515_abs_of_code {s₀ s₉ : State} { var_owner var_spender var_value var_emitEvent} {fuel : Nat} :
  execCall fuel fun_approve_515 [] (s₀, [var_owner, var_spender, var_value, var_emitEvent]) = s₉ →
  Spec (A_fun_approve_515  var_owner var_spender var_value var_emitEvent) s₀ s₉
:= λ h ↦ fun_approve_515_abs_of_concrete (fun_approve_515_concrete_of_code.2 h)
