...
def A_switch_8694440494872382586 (s₀ s₉ : State) : Prop := sorry

lemma switch_8694440494872382586_abs_of_concrete {s₀ s₉ : State} :
  Spec switch_8694440494872382586_concrete_of_code s₀ s₉ →
  Spec A_switch_8694440494872382586 s₀ s₉ := by
  sorry
