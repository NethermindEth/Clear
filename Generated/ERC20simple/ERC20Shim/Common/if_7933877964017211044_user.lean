...
def A_if_7933877964017211044 (s₀ s₉ : State) : Prop := sorry

lemma if_7933877964017211044_abs_of_concrete {s₀ s₉ : State} :
  Spec if_7933877964017211044_concrete_of_code s₀ s₉ →
  Spec A_if_7933877964017211044 s₀ s₉ := by
  sorry
