...
def A_if_7567335688764008016 (s₀ s₉ : State) : Prop := sorry

lemma if_7567335688764008016_abs_of_concrete {s₀ s₉ : State} :
  Spec if_7567335688764008016_concrete_of_code s₀ s₉ →
  Spec A_if_7567335688764008016 s₀ s₉ := by
  sorry
