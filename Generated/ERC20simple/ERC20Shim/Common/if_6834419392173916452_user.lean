...
def A_if_6834419392173916452 (s₀ s₉ : State) : Prop := sorry

lemma if_6834419392173916452_abs_of_concrete {s₀ s₉ : State} :
  Spec if_6834419392173916452_concrete_of_code s₀ s₉ →
  Spec A_if_6834419392173916452 s₀ s₉ := by
  sorry
