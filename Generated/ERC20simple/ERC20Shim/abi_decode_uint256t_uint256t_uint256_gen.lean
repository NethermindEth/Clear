...
def abi_decode_uint256t_uint256t_uint256 : FunctionDefinition := <f
...
def abi_decode_uint256t_uint256t_uint256_concrete_of_code
: {
    C :
      _ → _ → _ → _ → _ → 
      State → State → Prop
  ...
  unfold abi_decode_uint256t_uint256t_uint256
